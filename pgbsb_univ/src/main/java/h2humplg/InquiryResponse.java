...
public class InquiryResponse {
	...
	public String toString() {
		return "InquiryResponse [nomorPembayaran=" + nomorPembayaran
				+ ", idTagihan=" + idTagihan + ", nomorInduk=" + nomorInduk
				+ ", nama=" + nama + ", fakultas=" + fakultas + ", jurusan="
				+ jurusan + ", strata=" + strata + ", angkatan=" + angkatan
				+ ", jumlahItem=" + jumlahItem + ", itemPembayaran="
				+ itemPembayaran + ", totalNominal=" + totalNominal + ", code="
				+ code + ", message=" + message + ", origin=" + origin + "]";
	}
